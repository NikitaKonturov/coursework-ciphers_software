...
Source: "C:\Development\course_work\temp_repo\coursework-ciphers_software\Ciphers.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Development\course_work\temp_repo\coursework-ciphers_software\Config.env"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Development\course_work\temp_repo\coursework-ciphers_software\Ciphers\*"; DestDir: "{app}\Ciphers"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "C:\Development\course_work\temp_repo\coursework-ciphers_software\Dictionaries\*"; DestDir: "{app}\Dictionaries"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "C:\Development\course_work\temp_repo\coursework-ciphers_software\custom"; DestDir: "{app}\custom"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "C:\Development\course_work\temp_repo\coursework-ciphers_software\static\*"; DestDir: "{app}\static"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "C:\Development\course_work\temp_repo\coursework-ciphers_software\templates\*"; DestDir: "{app}\templates"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "C:\Development\course_work\temp_repo\coursework-ciphers_software\VC_redist.x64.exe"; DestDir: "{app}"; Flags: deleteafterinstall
