#include "Homophone_cipher/Homophone_cipher.hpp"
...
PYBIND11_MODULE(Homophone_cipher, m) {
    m.doc() = "Homophone_cipher"; // документация к модулю питона, обязана содержать имя библиотеки на английском которое будет отображаться во frontend
