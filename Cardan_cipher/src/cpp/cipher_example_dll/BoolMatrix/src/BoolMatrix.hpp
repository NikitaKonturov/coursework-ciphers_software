...
public:
    ...
    BoolMatrix(std::string);                // Для заполнения матрицы из строки вида "0010001000101", рассчет длины стороны матрицы = корень из длины строки, добавить проверку: сторона^2 == sqrt(str.size())
    ~BoolMatrix();
