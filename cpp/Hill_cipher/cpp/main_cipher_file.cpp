#include "cipher_first/Hill-cipher.hpp"
...
PYBIND11_MODULE(Hill_cipher, m) {
    m.doc() = "Шифр Хила"; // документация к модулю питона, обязана содержать имя библиотеки на английском которое будет отображаться во frontend
